...
class Users(AbstractBaseUser, PermissionsMixin):
    ...
    profile_imageUrl = models.CharField(max_length=1000, blank=True, null=True)
    background_imageId =  models.CharField(max_length=255, blank=True, null=True)
    background_imageUrl = models.CharField(max_length=1000, blank=True, null=True)
    address = models.TextField()
    Program = models.CharField(max_length=255, blank=True, null=True)
    courses = models.ManyToManyField(Course, blank=True)  # Change ForeignKey to ManyToManyField
    Term = models.CharField(max_length=255, blank=True, null=True)
    school_credentials_imageId = models.CharField(max_length=255, blank=True, null=True)
    school_credentials_imageUrl = models.CharField(max_length=1000, blank=True, null=True)
